...
public class PieceI extends Piece {
	...
	public void goInHold() {
		...
		blocks[2].setY(Map.START_HOLD_Y);
	...
	public void goToStart() {
		...
		blocks[2] = new Rectangle(800 / 2-Piece.BLOCK_HEIGHT, Map.START_Y, Piece.BLOCK_HEIGHT,
				Piece.BLOCK_HEIGHT);
		blocks[3] = new Rectangle(800 / 2-Piece.BLOCK_HEIGHT*2, Map.START_Y, Piece.BLOCK_HEIGHT,
				Piece.BLOCK_HEIGHT);
	}
}
